...
public class Philosopher extends Thread {
	private static volatile Semaphore waitingForChopstick = new Semaphore(4, true);
	...
	public void run() {
		while(true){
			...
			while(waitingForChopstick.availablePermits() == 0) {
				// Print to console that I am thinking
				System.out.println("4 philosophers are trying to eat, so "+getName()+" goes back to thinking");
